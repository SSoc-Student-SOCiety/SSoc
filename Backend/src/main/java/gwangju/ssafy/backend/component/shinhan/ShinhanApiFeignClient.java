...
interface ShinhanApiFeignClient {
	...
	ShinhanApiDto<ShinhanResponseHeader, ShinhanBalanceDetailApi.Response> getBalanceDetail(@RequestBody ShinhanApiDto<ShinhanApiKey, ShinhanBalanceDetailApi.Request> request);
